function codificar() {
    let novoTexto = input.value.replace(/a|e|i|o|u/g,function(ocorrencia){return codifica[ocorrencia];});
    output.value = novoTexto;
}

function decodificar() {
    let novoTexto = input.value.replace(/ai|enter|imes|ober|ufat/g,function(ocorrencia){return decodifica[ocorrencia];});
    output.value = novoTexto;
}
